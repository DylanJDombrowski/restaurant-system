    ...
    return (
      <div className="flex flex-col justify-center items-center h-screen">
        <div className="text-center max-w-md">
          ...
          <button onClick={() => window.location.reload()} className="bg-gray-300 text-gray-900 px-4 py-2 rounded hover:bg-gray-400">
            Refresh Page
          </button>
        </div>
      </div>
    ...
    if (userLevel < requiredLevel) {
      return (
        <div className="text-center py-16">
          ...
          <p className="text-gray-900">You need {requireRole} or higher privileges to access this area.</p>
          <p className="text-sm text-gray-900 mt-2">Current role: {staff.role}</p>
        </div>
      );
    }
  }
