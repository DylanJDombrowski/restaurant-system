...
import { ConfiguredCartItem, MenuItemWithVariants, ConfiguredModifier } from "@/lib/types";
...
const SANDWICH_STYLES: SandwichStyle[] = [
  ...
  { id: "natural_gravy", name: "natural_gravy", label: "Natural Gravy", price: 0 },
        ...
        {ingredient.tiers.map((tier) => (
          <button
            ...
            className={`px-2 py-1 text-xs font-medium rounded transition-colors ${
              currentTier === tier.level ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
            }`}
          >
            {tier.label}
          </button>
