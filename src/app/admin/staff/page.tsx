...
function SetPinModal({ staff, onClose, onPinSet }: { staff: Staff | null; onClose: () => void; onPinSet: () => void }) {
      ...
      <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
        <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md m-4">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold mb-4 text-gray-800">PIN Generated for {staff.name}</h2>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-md m-4">
        <h2 className="text-xl font-bold mb-4 text-gray-800">Set PIN for {staff.name}</h2>

        {/* PIN Method Selection */}
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-3">PIN Setup Method</label>
          <div className="space-y-2">
            <label className="flex items-center space-x-3 cursor-pointer">
              ...
              />
              <div>
                <div className="font-medium text-gray-800">Generate Random PIN</div>
                <div className="text-sm text-gray-600">System will create a secure 6-digit PIN</div>
              </div>
            </label>
            <label className="flex items-center space-x-3 cursor-pointer">
              <input
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Choose your own 6-digit PIN</div>
              </div>
            </label>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {useCustomPin && (
            <div className="mb-4">
              ...
              />
              <div className="text-xs text-gray-500 mt-1">Must be exactly 6 digits (numbers only)</div>
            </div>
          )}
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage staff accounts and 6-digit PINs for {restaurant?.name}</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        {staff.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mt-1">Add your first staff member to get started</p>
          </div>
        ) : (
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center space-x-3 mt-1">
              ...
              <span className="text-sm text-gray-500">Joined: {joinedDate}</span>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              disabled={isEditing}
            />
            {isEditing && <p className="text-xs text-gray-500 mt-1">Email cannot be changed after account creation</p>}
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Staff: Basic operations • Manager: Menu management • Admin: Full access</p>
          </div>
